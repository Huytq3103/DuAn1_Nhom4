...
public class ViewHoaDon extends javax.swing.JPanel {
    ...
    public ViewHoaDon() {
        ...
        String[] headerSanPham = {"Tên", "Màu sắc", "Hãng", "Kích cỡ", "Chất liệu", "Loại", "Số Lượng tồn", "Giá"};
        String[] headerGioHang = {"Tên", "Màu sắc", "Hãng", "Kích cỡ", "Chất liệu", "Loại", "Số Lượng", "Giá"};
        String[] headerHoaDon = {"Nhân viên", "Khách hàng", "Trạng thái", "Ngày tạo", "Ngày thanh toán", "Tổng tiền"};
